// src/components/parts/PartDiagramViewer.jsx
//
// Shearers copy — see the CCW app for the original. Styling here is inline, so
// this one ports across the Bootstrap/Tailwind divide unchanged apart from
// button classes.
//
...
export default function PartDiagramViewer({
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-2">
          {src && (
            <>
              ...
              <span className="text-xs text-white/70" style={{ minWidth: '3.2rem', textAlign: 'center' }}>
      ...
      >
        {error && <div className="text-amber-300 p-3">{error}</div>}
        {!error && !src && <div className="text-white/70 p-3">Loading the drawing…</div>}
        {src && (
          <span
            style={{
