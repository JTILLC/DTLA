    ...
    <div className="max-w-6xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md md:p-4 sm:p-2">
      ...
      <div className="flex justify-between items-center mb-3 gap-2">
        ...
        <div className="flex gap-2">
          <button
            onClick={selectAll}
            className="px-3 py-2 bg-green-600 text-white rounded text-sm hover:bg-green-700 sm:px-2 sm:py-1"
          >
            Select All ({rows.length})
          </button>
          <button
            onClick={clearSelection}
            className="px-3 py-2 bg-gray-500 text-white rounded text-sm hover:bg-gray-600 sm:px-2 sm:py-1"
          >
            Clear Selection
          </button>
          {selectedKeys.size > 0 && (
            <span className="px-3 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded text-sm font-semibold">
