...
export default function Dashboard({ data = {}, dates: propDates = [] }) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md md:p-4 sm:p-2">
      ...
      {dates.length > 0 && (
        <div className="mb-6">
          <h3 className="text-xl font-semibold mb-3 text-center sm:text-lg dark:text-gray-100">
            Daily Heads Down Totals
          </h3>
            ...
            <table className="w-full table-auto border-collapse">
              <thead>
                <tr className="bg-gray-200 dark:bg-gray-700">
                  <th className="p-3 text-center border dark:border-gray-600 dark:text-gray-100 font-semibold">Date</th>
                  <th className="p-3 text-center border dark:border-gray-600 text-red-700 dark:text-red-300 font-semibold">Total Offline</th>
                  <th className="p-3 text-center border dark:border-gray-600 text-orange-700 dark:text-orange-300 font-semibold">Total Fixed</th>
                  <th className="p-3 text-center border dark:border-gray-600 text-yellow-700 dark:text-yellow-300 font-semibold">Not Fixed</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <tr key={d} className={selectedDate === d ? 'bg-blue-50 dark:bg-blue-900/30' : ''}>
                      <td className="p-2 text-center border dark:border-gray-600 dark:text-gray-200 font-medium">
                        {d}
                        {selectedDate === d && <span className="ml-2 text-blue-600 dark:text-blue-400 text-xs">(selected)</span>}
                      </td>
                      <td className="p-2 text-center border dark:border-gray-600 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 font-bold text-lg">
                        {dayStats.offline}
                      </td>
                      <td className="p-2 text-center border dark:border-gray-600 bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 font-bold text-lg">
                        {dayStats.fixed}
                      </td>
                      <td className="p-2 text-center border dark:border-gray-600 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-300 font-bold text-lg">
                        {dayStats.notFixed}
                      </td>
                    </tr>
                  );
