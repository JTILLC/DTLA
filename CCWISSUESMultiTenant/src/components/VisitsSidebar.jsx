    ...
    <aside className="visits-sidebar" aria-label="Visits">
      <div className="visits-sidebar-header">
        <div className="visits-sidebar-title">
          <span className="visits-sidebar-label">Daily Logs</span>
          {customerName && (
      ...
      <div className="visits-sidebar-list" role="list">
        {visits.length === 0 && (
          <div className="visits-sidebar-empty">
            No daily logs yet. Click <strong>+ New Log</strong> to create one.
          </div>
        )}
        {visits.map((v) => {
            ...
            >
              <div className="visits-sidebar-item-main">
                ...
                <div className="visits-sidebar-item-date">
                  ...
                  {v.shift ? (
                    <span className="badge bg-info text-dark ms-2" title="Shift">{v.shift}</span>
                  ) : (
                    <span className="badge bg-primary ms-2" title="Service visit logged by JTI">JTI Visit</span>
                  )}
