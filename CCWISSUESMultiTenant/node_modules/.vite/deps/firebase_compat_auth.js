...
function _checkCordovaConfiguration(auth) {
  ...
  _assert(typeof win?.universalLinks?.subscribe === "function", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-universal-links-plugin-fix"
  });
  _assert(typeof win?.BuildInfo?.packageName !== "undefined", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-plugin-buildInfo"
  });
  _assert(typeof win?.cordova?.plugins?.browsertab?.openUrl === "function", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-plugin-browsertab"
  });
  _assert(typeof win?.cordova?.plugins?.browsertab?.isAvailable === "function", auth, "invalid-cordova-configuration", {
    missingPlugin: "cordova-plugin-browsertab"
  });
  _assert(typeof win?.cordova?.InAppBrowser?.open === "function", auth, "invalid-cordova-configuration", {
